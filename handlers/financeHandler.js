...
class FinanceHandler {
 ...
 // ✅ VERIFICAÇÃO CRÍTICA: Se já respondeu/deferiu, ignorar
 if (interaction.replied || interaction.deferred) {
 console.log(`[Finance] processWithdrawRequest: Interação ${interaction.id} já respondida. Ignorando.`);
 return;
 }

 // ✅ DEDUPLICAÇÃO
 if (!deduplicateInteraction(interaction.id)) {
 console.log(`[Finance] processWithdrawRequest: Interação ${interaction.id} duplicada. Ignorando.`);
 return;
 }
 ...
 // ✅ VERIFICAÇÃO CRÍTICA: Se já respondeu/deferiu, ignorar
 if (interaction.replied || interaction.deferred) {
 console.log(`[Finance] processLoanRequest: Interação ${interaction.id} já respondida. Ignorando.`);
 return;
 }

 // ✅ DEDUPLICAÇÃO
 if (!deduplicateInteraction(interaction.id)) {
 console.log(`[Finance] processLoanRequest: Interação ${interaction.id} duplicada. Ignorando.`);
 return;
 }
 ...
 // ✅ VERIFICAÇÃO CRÍTICA: Se já respondeu/deferiu, ignorar
 if (interaction.replied || interaction.deferred) {
 console.log(`[Finance] processLoanPaymentRequest: Interação ${interaction.id} já respondida. Ignorando.`);
 return;
 }

 // ✅ DEDUPLICAÇÃO
 if (!deduplicateInteraction(interaction.id)) {
 console.log(`[Finance] processLoanPaymentRequest: Interação ${interaction.id} duplicada. Ignorando.`);
 return;
 }
 ...
 // ✅ VERIFICAÇÃO CRÍTICA: Se já respondeu/deferiu, ignorar
 if (interaction.replied || interaction.deferred) {
 console.log(`[Finance] processTransferRequest: Interação ${interaction.id} já respondida. Ignorando.`);
 return;
 }

 // ✅ DEDUPLICAÇÃO
 if (!deduplicateInteraction(interaction.id)) {
 console.log(`[Finance] processTransferRequest: Interação ${interaction.id} duplicada. Ignorando.`);
 return;
 }
